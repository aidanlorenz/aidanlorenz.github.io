...
I imagine this taking on an agentic design where the user interacts with an LLM to express their route preferences, and the LLM has access to agents with tools such as an elevation calculator, a waypoint generator, etc.
